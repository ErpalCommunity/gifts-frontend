    ...
    <Router>
      <div className="App">
        <div className="titles">
          <img src="gift-title.png" className="image-title" alt="Gift" />
        ...
        <div className="gift-grid1">
          ...
          <div className="gift-card1">
            ...
            <img src="Animated_AgADgRgAApWfiUo.gif" alt="Delicious Cake" className="gift-image" />
            <p className="gift-name">Delicious Cake</p>
              <button className="gift-price">
                <img src={`${process.env.PUBLIC_URL}usdt.svg`} alt="USDT" className="price-icon" /> 10 USDT
              </button>
          </div>
          ...
          <div className="gift-card2">
            ...
            <button className="gift-price">
              <img src={`${process.env.PUBLIC_URL}ton.svg`} alt="TON" className="price-icon" /> 5 TON
            </button>
          </div>
        </div>
        ...
        <div className="gift-grid2">
          <div className="gift-card3">
            ...
            <button className="gift-price">
              <img src={`${process.env.PUBLIC_URL}ethereum.svg`} alt="ETH" className="price-icon" /> 0.01 ETH
            </button>
          </div>
